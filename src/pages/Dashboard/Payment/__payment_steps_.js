 ...
 * 5. create payment intent post on the sever. and return client secret install stripe on the server side and get client secret. make sure you used the payment method types : ['card']
